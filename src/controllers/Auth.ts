...
import { OtpVerification } from "../mail/emailVerificationOtp";
...
export const sendotp = async (
  ...
  try {
    ...
    try {
      const responseinfo = await mailsender(
        email,
...
export const signup = async (
  ...
  try {
    ...
    const fetchedOTP = recentOtp[0]?.otp;
    ...
    // explore more about types of cookies options
